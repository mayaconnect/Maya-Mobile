...
// Configuration
const KEY_ID = '77TBY8NS79';
const ISSUER_ID = '5a1bb2ff-02b3-4d58-b9d9-ab4639893fba';
const KEY_PATH = './fastlane/keys/AuthKey_77TBY8NS79.p8';

console.log('🔍 Test des credentials App Store Connect\n');
...
const req = https.request(options, (res) => {
  ...
  res.on('end', () => {
    ...
    if (res.statusCode === 200) {
      ...
      console.log('\n✅ Vos credentials sont VALIDES et fonctionnent correctement!');
      console.log('   Le problème vient probablement d\'EAS ou de la configuration fastlane.\n');

    } else if (res.statusCode === 401) {
      console.log('❌ ❌ ❌ AUTHENTIFICATION ÉCHOUÉE ❌ ❌ ❌\n');
      console.log('Causes possibles:');
      console.log('  1. La clé API a été révoquée dans App Store Connect');
      console.log('  2. Le Key ID ou Issuer ID est incorrect');
      console.log('  3. Le fichier .p8 ne correspond pas au Key ID');
      console.log('  4. La clé n\'a pas les permissions nécessaires (doit être App Manager ou Admin)\n');

      console.log('🔧 Solutions:');
      console.log('  1. Vérifiez dans App Store Connect → Users and Access → Keys');
      console.log('  2. Vérifiez que la clé est Active');
      console.log('  3. Vérifiez le rôle de la clé (App Manager minimum)');
      console.log('  4. Si nécessaire, créez une nouvelle clé\n');

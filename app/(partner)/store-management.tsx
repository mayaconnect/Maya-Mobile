 ...
 *
 * Uses the storeId from the partner's active store (Zustand).
 */
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.centerContent}>
          ...
          <Text style={styles.lockedTitle}>Aucun magasin actif</Text>
          <Text style={styles.lockedText}>
            Veuillez d'abord sélectionner un magasin actif.
          </Text>
          <MButton
            title="Retour"
            variant="outline"
      ...
      >
        ...
        <MCard style={styles.storeInfo} elevation="sm">
          <View style={styles.storeInfoRow}>
            ...
            <MBadge label="Partenaire" variant="violet" size="sm" />
          </View>
        </MCard>
